...
public class NeueOrgaEinheitFrage extends JDialog {
	...
	private int NeueOrgaEinheitLeiter;
	private int RechteLeiter;
	private int RechteMitarbeiter;
	

	public NeueOrgaEinheitFrage(String Benutzername, String Passwort, Webservice port, String NeueOrgaEinheitName, int NeueOrgaEinheitLeiter, int UeberOrgaNr, int RechteLeiter, int RechteMitarbeiter) {
	this.Benutzername = Benutzername;
	this.Passwort = Passwort;
	this.port = port;
	this.NeueOrgaEinheitName = NeueOrgaEinheitName;
	this.NeueOrgaEinheitLeiter = NeueOrgaEinheitLeiter;
